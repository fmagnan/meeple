...
def test_princess_does_not_fit_well_with_empress():
...
def test_full_when_candle_bell_tower_book_of_changes_any_wizard():
...
def test_world_tree_no_points_when_book_of_changes_creates_shared_suit():
    hand = init_hand([Name.COLLECTOR, Name.WORLD_TREE])
...
def test_cannot_choose_any_card_with_fountain_of_life_and_only_artifacts():
    ...
    hand.add_card(
        Name.BOOK_OF_CHANGES, {"card": Name.PROTECTION_RUNE, "suit": Suit.WILD}
    )
